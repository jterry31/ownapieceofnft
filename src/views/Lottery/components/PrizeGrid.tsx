...
const PrizeGrid: React.FC<PrizeGridProps> = ({
  ...
  const ccakePriceFour = (1 * fourMatchesAmount).toFixed(2);
  const ccakePriceThree = (1 * threeMatchesAmount).toFixed(2);
  const ccakePriceTwo = (1 * twoMatchesAmount).toFixed(2);
  const ccakePriceBurn = (1 * burnAmount).toFixed(2);
